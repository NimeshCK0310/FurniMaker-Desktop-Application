...
public class Bed extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("3D FurniturePackage.Bed");
    ...
    private void prepareBackground(Group root) {
        ...
        backgroundMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/resources/v.jpg")));

        Box background = new Box(WIDTH * 2, HEIGHT * 2, 1);
        background.setMaterial(backgroundMaterial);
        background.setTranslateZ(-1000); // Adjusted for bed visualization
    ...
    private void prepareBed(SmartGroup group) {
        ...
        mattressMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/resources/wood.jpg"))); // Consider using a fabric texture for a more realistic mattress
