...
public class Cupboard extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("3D Modern FurniturePackage.Cupboard");
    ...
    private void prepareCupboard(SmartGroup group) {
        ...
        material.setDiffuseMap(new Image(getClass().getResourceAsStream("/resources/wood.jpg"))); // Replace with a modern texture
