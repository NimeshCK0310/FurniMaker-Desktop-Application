...
public class DashboardApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Pane boxObject = createBox("Object");
        boxesGrid.add(boxObject, 0, 0);

        Pane boxFurnitureRoom = createBox("Furniture Room"); // Added for completeness
    ...
    private Pane createAboutPage() {
        ...
        Label contactInfo = new Label("Name: Sachith Priyamantha\nPhone: +94751234567\nEmail: sachithpriyamantha@gmail.com.");
